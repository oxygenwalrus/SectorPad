...
Version 1.2.0 adds a ten-second SDL/XInput discovery test, reconnect-on-focus recovery, touchscreen-safe SectorPad panels, and optional Steam Input mouse-style gyro aiming. For SteamOS/Lutris setup, see [handheld, touch and gyro instructions](docs/HANDHELDS_AND_DIAGNOSTICS.md#steamos-with-lutriswine-or-proton).
