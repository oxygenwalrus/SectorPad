...
Version 1.3.0 refines TriPad into a modern instrument-panel style: layered navy surfaces, restrained cyan edge lighting, amber focus, a segmented radial rim, and a clearer ship schematic and equipment list. The keyboard, controller setup, navigation cues and native frame skin share the same original visual language. Starsector's Insignia fonts, native icons and gameplay behavior stay intact. See [the design and offscreen previews](docs/UI_REFINEMENT.md).
