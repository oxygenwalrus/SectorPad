...
Version 1.5.0 brings sourced device artwork into TriPad: Valve's Steam Deck illustration, Zacksly's Xbox Series controller and button graphics, the community ROG Ally illustration, and Kenney prompts. Controller Setup retains live button, stick and trigger feedback with highlights aligned to each device. Refit, radial, keyboard and status prompts share the matching button artwork. See [artwork and credits](docs/CONTROLLER_ART.md) and [the visual previews](docs/UI_REFINEMENT.md).
